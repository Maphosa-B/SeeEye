...
set JAVAFX_HOME="C:\Program Files\AdoptOpenJDK\javafx-sdk-11"
...
javadoc --module-path %JAVAFX_HOME%\lib --add-modules=%JAVAFX_MODULES% -sourcepath %PRAC_SRC% -classpath %PRAC_BIN%;%PRAC_LIB% -use -version -author -d %PRAC_DOCS%\JavaDocs -subpackages gui
IF /I "%ERRORLEVEL%" NEQ "0" (
